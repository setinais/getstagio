...
class CadastroAdicionalController extends HXPHP\System\Controller
{
	...
	public function indexAction($acao=null)
	{
			...
			$this->view->setVar('request',$post)->setAssets('js',[$this->configs->baseURI.'public/js/jquery.js',$this->configs->baseURI.'public/js/cadastro/cadastro.js',$this->configs->baseURI.'public/js/jquery.1.7.7.mask.min.js',$this->configs->baseURI.'public/js/validaCpfCnpj.js',$this->configs->baseURI.'public/js/cadastroadicional/jqBootstrapValidation.js',$this->configs->baseURI.'public/js/cadastroadicional/contact_me.js']);
